...
import com.mrboomdev.uust.BuildConfig
import com.mrboomdev.uust.Uust
import com.mrboomdev.uust.setContext
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(BuildConfig.DEBUG) {
            ...
            Composer.Companion.setDiagnosticStackTraceMode(ComposeStackTraceMode.Companion.SourceInformation)
        }
